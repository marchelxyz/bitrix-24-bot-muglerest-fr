...
class Bitrix24Client:
    ...
    def get_recent_task_comments(self, since: datetime = None) -> List[Dict]:
        ...
        2. Создайте новый вебхук с событиями: OnTaskUpdate, OnTaskCommentAdd
        3. Укажите URL вашего сервера для приема событий
        ...
        logger.info("   События: OnTaskUpdate, OnTaskCommentAdd")
        return []
